...
*
* @var object $epi                       Les données d'un EPI.
* @var integer $manufacture_date_valued  Le setting date de fabrication d'un EPI.
* @var boolean $edit_mode                True si il s'agit d'une edition de l'EPI.
* @var boolean $checked_purchase_date    True si le setting date d'achat est actif.
*/
?>
...
<div class="row-advanced service main wpeo-form form-light" data-id="<?php echo esc_attr( $epi->data['id'] ); ?>">
	...
	<div class="advanced-service information wpeo-form">
		...
		<div class="wpeo-gridlayout grid-3 grid-padding-1">
			...
			<?php Service_Class::g()->display_autocomplete_manager( $epi ); ?>
