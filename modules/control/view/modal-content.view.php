...
<div class="wpeo-table table-flex control-epi">
	<div class="table-row table-header" style="background-color : #0084ff">
		...
		<div class="table-cell table-300" style="text-align : center;" data-title="<?php esc_attr_e( 'Comment', 'theepi' ); ?>"><i class="fas fa-barcode"></i> <?php esc_html_e( 'Comment', 'theepi' ); ?></span></div>
		<div class="table-cell table-300" style="text-align : center;" data-title="<?php esc_attr_e( 'URL', 'theepi' ); ?>"><span><?php esc_html_e( 'URL', 'theepi' ); ?></span></div>
	...
	<div class="tab-container control-epi">
		...
		<?php Control_Class::g()->display_control_list( $epi ) ?>
	</div>

	<!-- <div clas="pagination epi-control" style="margin-top: 20px">
