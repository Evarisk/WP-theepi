...
class Control_Class extends \eoxia\Post_Class {
	...
	public function display_control_list( $epi ) {
	...
	public function display_modal_content( $epi ) {
	...
	*
	* @return array $controls[key]  retourne l'control le plus récent.
	*/
