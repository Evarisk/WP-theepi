...
class EPI_Action {
	...
	public function __construct() {
		...
		if ( in_array( $page, Config_Util::$init['digirisk-epi']->insert_scripts_pages, true ) ) {
	...
	public function callback_admin_menu() {
		...
		add_submenu_page( 'digirisk-simple-risk-evaluation', __( 'EPI', 'digirisk' ), __( 'EPI', 'digirisk' ), 'manage_options', 'digirisk-epi', array( EPI_Class::g(), 'display' ) );
	}
}
